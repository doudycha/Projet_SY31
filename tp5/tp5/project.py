...
class Projector(Node):
    def __init__(self):
        ...
        self.pub = self.create_publisher(Image, "projections", 10)
        ...
        self.sub_info = self.create_subscription(
            CameraInfo, "turtlecam/camera_info", self.callback_info, 10
        )
        self.sub_img = self.create_subscription(
            Image, "turtlecam/image_rect", self.callback_img, 10
        )
    ...
    def find_checkerboard_transfo(self, img: np.ndarray) -> np.ndarray:
        ...
        # TODO: Find the corners in the image (see OpenCV's findChessboardCorners)
        # ...
